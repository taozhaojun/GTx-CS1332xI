...
public class AVL<T extends Comparable<? super T>> {
    ...
    public void updateHeightAndBF(AVLNode<T> currentNode) {
        ...
        int height = 1 + Math.max(leftChildHeight, rightChildHeight);
        currentNode.setHeight(height);

        int balanceFactor = leftChildHeight - rightChildHeight;
    ...
    public AVLNode<T> rotateLeft(AVLNode<T> currentNode) {
        // WRITE YOUR CODE HERE (DO NOT MODIFY METHOD HEADER)!
        AVLNode<T> newParent = currentNode.getRight();
    ...
    public AVLNode<T> rotateRight(AVLNode<T> currentNode) {
        // WRITE YOUR CODE HERE (DO NOT MODIFY METHOD HEADER)!
        AVLNode<T> newParent = currentNode.getLeft();
